package com.codecool.FileManipulators;
...
public class FileWordAnalyzer {
    ...
    public ArrayList wordsContainingSubString(String subString) {
        ...
        for(String word : Objects.requireNonNull(this.getContentAsList())) {
    ...
    public ArrayList wordsArePalindrome() {
        ArrayList<String> outputList = new ArrayList<>();
        for(String word : Objects.requireNonNull(getContentAsList())) {
